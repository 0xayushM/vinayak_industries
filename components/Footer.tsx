            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="text-gray-400 text-sm">
                  ...
                  <span>, </span>
                  <a href="tel:+919311378901" className="hover:text-amber-500 transition-colors">9311378901</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-amber-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:vinayaktechnoplast@gmail.com" className="text-gray-400 hover:text-amber-500 transition-colors text-sm">
