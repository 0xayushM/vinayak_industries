      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-2 relative">
            ...
            <button
              onClick={() => scroll('left')}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-amber-500 hover:bg-amber-600 text-white p-1 md:p-3 rounded-full shadow-lg transition-all hover:scale-110"
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-amber-500 hover:bg-amber-600 text-white p-1 md:p-3 rounded-full shadow-lg transition-all hover:scale-110"
